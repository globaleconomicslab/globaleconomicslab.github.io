...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (projectGrid && projectDotEls.length) {
    var projects = [
      ...
      { title: 'The Future of Tax Policy: Public Finance in the Age of AI', subtitle: '', href: 'public-finance-age-of-ai.html', img: 'images/topics/ai3.jpg', alt: 'Abstract illustration of an AI circuit brain', objectPosition: 'center 22%' },
