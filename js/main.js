document.addEventListener('DOMContentLoaded', function () {
  ...
  if (joinForm) {
    joinForm.addEventListener('submit', function (e) {
      ...
      var cvFile = document.getElementById('join-cv').files[0];
      var cvNote = cvFile
        ? '\n\n(Please attach your CV — ' + cvFile.name + ' — to this email before sending.)'
        : '\n\n(Please attach your CV to this email before sending.)';
      var body = 'Name: ' + name + '\nEmail: ' + email + '\n\n' + message + cvNote;
      var mailtoFallback = 'mailto:' + LAB_EMAIL
        + '?subject=' + encodeURIComponent('Join Our Team — ' + name)
        + '&body=' + encodeURIComponent(body);
      submitToFormspree(
        joinForm,
        document.getElementById('join-form-status'),
        mailtoFallback,
        'Thanks — your application has been received. We’ll be in touch when a suitable opening comes up.'
      );
    });
  }
  ...
  if (bioModal) {
    var bios = {
      ...
      valere: {
        name: 'Valère Piérard',
        role: 'Lab Manager and Chief of Staff to the Director',
      ...
      kalemliozcan: {
        ...
        role: 'Schreiber Family Professor of Economics, Brown University',
        photo: 'https://sebnemkalemliozcan.com/assets/img/sebnem_ciragan2.JPG',
        email: '',
        bio: '<p>Şebnem Kalemli-Özcan is Schreiber Family Professor of Economics at Brown University and the Director of the Global Linkages Lab. She is a Research Associate at the National Bureau of Economic Research (NBER) and a Research Fellow at the Center for Economic Policy Research (CEPR).</p><p>Currently, she is the co-editor of American Economic Journal: Macroeconomics. She also serves at the economic advisory panels of the NY Federal Reserve and the Bank of International Settlements. Formerly, she was the Duisenberg Fellow at the European Central Bank, Lead Economist for the Middle East and North Africa Region of the World Bank, Houblon-Norman Fellow of Bank of England, Senior Policy Advisor at the International Monetary Fund and the International Fellow of Council of Foreign Relations, where she is also an elected member.</p><p>She is the first Turkish social scientist who has received the 2008 Marie Curie IRG prize aimed to reverse brain drain for her research on European financial integration. Her research focuses on the impact of global trade and financial linkages on economic fluctuations and growth.</p>',
        links: [
  ...
  if (topicModal) {
    var topics = {
      'global-finance': {
        ...
        papers: [
          { label: 'Stablecoins After GENIUS: Private Money, Public Debt, and the Global Dollar', sub: 'Liang & Neiman, Economic Strategy Group, August 18, 2026', url: 'https://www.economicstrategygroup.org/publication/stablecoins-after-genius-private-money-public-debt-and-the-global-dollar/' },
        ...
        speeches: [
          { label: 'Stablecoins and Anonymous Money', sub: 'Gopinath, 2026 Per Jacobsson Lecture, Bank for International Settlements', url: 'https://www.bis.org/events/agm2026/sp260628_lecture.pdf' },
          { label: 'Money and Sovereignty', sub: 'Gopinath, Central Bank of Chile Annual Conference, Nov 2025', url: 'https://www.youtube.com/watch?v=482PmrzqHJg&t=28527s' },
          { label: 'Geopolitics and its Impact on Global Trade and the Dollar', sub: 'Gopinath, IMF, May 2024', url: 'https://www.imf.org/en/News/Articles/2024/05/07/sp-geopolitics-impact-global-trade-and-dollar-gita-gopinath' }
        ],
        media: [
          { label: 'Conflicting Policies, Confused Investors, and the Weak Dollar', sub: 'Kalemli-Özcan, Project Syndicate, February 17, 2026', url: 'https://www.project-syndicate.org/commentary/trump-populism-weakening-the-us-dollar-by-sebnem-kalemli-ozcan-2026-02' },
          { label: 'How Long Can the Dollar Go?', sub: 'Rogoff, Foreign Policy, June 2025', url: 'https://foreignpolicy.com/2025/06/30/dollar-inflation-growth-renminbi-euro-crypto/' },
          ...
          { label: 'This Time Is Really Different for the Dollar', sub: 'Rogoff, The Economist, May 2025', url: 'https://www.economist.com/by-invitation/2025/05/05/this-time-really-is-different-for-the-dollar-writes-kenneth-rogoff' }
        ],
        data: [
      ...
      fragmentation: {
        ...
        image: 'images/topics/geoeconomic-fragmentation.webp',
        papers: [
          ...
          { label: 'Global Networks, Monetary Policy and Trade', sub: 'Kalemli-Özcan, Soylu & Yıldırım, Current Draft: May 2026', url: 'https://sebnemkalemliozcan.com/assets/workingpapers/GlobalNetwork_Monetary_Policy_and_Trade_latest.pdf' },
          ...
          { label: 'The Remains of the Trade: The U.S.–China Trade War and Its Aftermath', sub: 'Antràs, Kulesza & Presbitero, 2026', url: 'https://antras.scholars.harvard.edu/sites/g/files/omnuum5876/files/2026-03/PAAPAlUla_1.pdf', dataUrl: 'https://pantras-hash.github.io/remains_of_the_trade/#rankings' },
          ...
          { label: 'Long-Run Trends in Long-Maturity Real Rates 1311-2022', sub: 'Rogoff, Rossi & Schmelzing, American Economic Review, 114(8), August 2024, pp. 2271-2307', links: [ { label: 'Working Paper', url: 'https://rogoff.scholars.harvard.edu/sites/g/files/omnuum5901/files/rogoff/files/long_run_trends_in_long_maturity_rates_revised_version_july_2023.pdf' }, { label: "Publisher's Version", url: 'https://www.aeaweb.org/articles?id=10.1257/aer.20221352&from=f' } ] },
          ...
          { label: 'Pricing Risk Globally: Intermediary Constraints, the Dollar, and the Global Financial Cycle', sub: 'Akinci, Kalemli-Özcan & Queralto', url: 'https://sebnemkalemliozcan.com/assets/workingpapers/AKOQ_Manuscript.pdf' },
          { label: 'Asset Elasticities and Currency Risk Transfer', sub: 'Bertaut, Faia, Kalemli-Özcan, Marchesini, Paetzold & Schmitz', url: 'https://sebnemkalemliozcan.com/assets/workingpapers/w34275.pdf' }
        ],
        speeches: [
          { label: 'Cold War II? Preserving Economic Cooperation Amid Geoeconomic Fragmentation', sub: 'Gopinath, 20th World Congress of the IEA, Dec 2023', url: 'https://www.imf.org/en/News/Articles/2023/12/11/sp121123-cold-war-ii-preserving-economic-cooperation-amid-geoeconomic-fragmentation' },
          { label: 'Europe in a Fragmented World', sub: 'Gopinath, 2023 Bernhard Harms Prize Acceptance Speech, Nov 2023', url: 'https://www.imf.org/en/News/Articles/2023/11/30/sp-fdmd-remarks-bernhard-harms-prize' },
          { label: 'Opening Remarks at the IMF Conference on Geoeconomic Fragmentation', sub: 'Gopinath, IMF, May 2023', url: 'https://www.imf.org/en/News/Articles/2023/05/25/sp052523-FDMD-GGopinath-Geoeconomic-Fragmentation' }
        ],
        media: [
          { label: 'The Yuan Is More Than a Symptom of Global Imbalances', sub: 'Gopinath, Gourinchas & Rey, The Economist, August 2026', url: 'https://www.economist.com/by-invitation/2026/08/10/the-yuan-is-more-than-a-symptom-of-global-imbalances' },
          { label: 'The World’s Superpowers Are Scrambling for an Edge. It Makes All of Us Less Safe', sub: 'Gourinchas, NY Times, July 2026', url: 'https://www.nytimes.com/2026/07/10/opinion/trade-war-economy-globalization.html' },
          { label: 'Global Imbalances: Old Questions, New Answers?', sub: 'Gourinchas, IMF Blog, April 2026', url: 'https://www.imf.org/en/blogs/articles/2026/04/06/global-imbalances-old-questions-new-answers' },
          { label: 'Interdependence Bites Back', sub: 'Kalemli-Özcan, Project Syndicate, March 27, 2026', url: 'https://www.project-syndicate.org/onpoint/iran-war-tariffs-risk-turning-economic-interdependence-into-a-liability-by-sebnem-kalemli-ozcan-2026-03' },
          { label: 'Tariff Wars! What are the Rates? Who Pays? What’s Next?', sub: 'Neiman, February 2026', url: 'https://www.youtube.com/watch?v=QhIwwhKaIys' },
          { label: 'Trade and Financial Policy for National Security and Supply Chain Resiliency', sub: 'Neiman, Hoover Institution panel with H.R. McMaster and Condoleezza Rice, February 20, 2026', url: 'https://www.youtube.com/watch?v=EctVr5rCJ_w' },
          { label: 'Tariffs are Worse Than You Think', sub: 'Kalemli-Özcan, Project Syndicate, January 26, 2026', url: 'https://www.project-syndicate.org/commentary/tariffs-costs-and-damage-to-economy-greater-than-many-understand-by-sebnem-kalemli-ozcan-2026-01' },
          { label: 'Tariffs, Global Imbalances, and the Dollar', sub: 'Itskhoki & Mukhin, VoxEU (CEPR), Nov 2025', url: 'https://cepr.org/voxeu/columns/tariffs-global-imbalances-and-dollar' },
          { label: 'The Trump White House Cited My Research To Justify Tariffs. It Got It All Wrong', sub: 'Neiman, NY Times, April 2025', url: 'https://www.nytimes.com/2025/04/07/opinion/trump-tariff-math-formula.html' },
          { label: 'Sanctions and the Exchange Rate', sub: 'Mukhin & Itskhoki, VoxEU (CEPR), May 2022', url: 'https://cepr.org/voxeu/columns/sanctions-and-exchange-rate' },
          { label: 'The Mussa Puzzle and the Optimal Exchange Rate Policy', sub: 'Itskhoki & Mukhin, VoxEU (CEPR), Jan 2022', url: 'https://cepr.org/voxeu/columns/mussa-puzzle-and-optimal-exchange-rate-policy' }
        ],
        data: [
      ...
      'emerging-tech': {
        ...
        papers: [
          ...
          { label: 'Preparing for the (Non-Existent?) Future of Work', sub: 'Juelfs & Korinek, Oxford Handbook of AI Governance, pp. 746-776, Apr. 2024', links: [ { label: 'Publication', url: 'https://academic.oup.com/edited-volume/41989/chapter-abstract/403300289' } ] },
          ...
          { label: 'Integrating Ethical Values and Economic Value to Steer Progress in Artificial Intelligence', sub: 'Korinek, in Markus Dubber et al. (eds.), Oxford Handbook of Ethics of Artificial Intelligence, Oxford University Press, July 2020', links: [ { label: 'Publication', url: 'https://www.oxfordhandbooks.com/view/10.1093/oxfordhb/9780190067397.001.0001/oxfordhb-9780190067397-e-30' } ] },
          { label: 'Artificial Intelligence and Its Implications for Income Distribution and Unemployment', sub: 'Korinek & Stiglitz, in Ajay Agrawal, Joshua Gans & Avi Goldfarb (eds.), The Economics of Artificial Intelligence, pp. 349-390, NBER and University of Chicago Press, May 2019', links: [ { label: 'Publication', url: 'https://drive.google.com/file/d/1HneWSeHoiPVYAZ7846T5uSlfHf4_EAdk/view?usp=sharing' }, { label: 'Presentation', url: 'https://www.youtube.com/watch?v=1tGHMhyte94&list=PLuCLRVi6Lc6cCzu7nwxUqKwJMykfFklZ3&index=17' } ] }
        ],
        speeches: [
          { label: 'Crisis Amplifier? How to Prevent AI from Worsening the Next Economic Downturn', sub: 'Gopinath, IMF, May 2024', url: 'https://www.imf.org/en/News/Articles/2024/05/30/sp053024-crisis-amplifier-how-to-prevent-ai-from-worsening-the-next-economic-downturn' },
          { label: 'The Power and Perils of the "Artificial Hand": Considering AI Through the Ideas of Adam Smith', sub: 'Gopinath, IMF, June 2023', url: 'https://www.imf.org/en/News/Articles/2023/06/05/sp060523-fdmd-ai-adamsmith' }
        ],
        media: [
          { label: 'The AI Growth Paradox', sub: 'Rogoff, Foreign Affairs, August 2026', url: 'https://www.foreignaffairs.com/united-states/ai-growth-paradox' },
          { label: 'The Canary in the AI Coal Mine', sub: 'Rogoff, Project Syndicate, August 3, 2026', url: 'https://www.project-syndicate.org/commentary/openai-hugging-face-breach-should-set-off-alarm-bells-by-kenneth-rogoff-2026-08' },
          { label: 'AI Could Drive Interest Rates Higher', sub: 'Rogoff, Charlie Rose Global Conversations, April 2026', url: 'https://www.youtube.com/shorts/c2bzI8dSMSk' },
          { label: 'Economic Policy Challenges for the Age of AI', sub: 'Korinek, in Rethinking Economic Policy: Steering Structural Change, MIT Press, 2025', links: [ { label: 'Find the book', url: 'https://mitpress.mit.edu/9780262051910/steering-structural-change/' }, { label: 'Read the paper', url: 'https://www.dropbox.com/scl/fi/ubxmal9cw4xplul8oscto/Economic_Policy_Challenges_Age_of_AI.pdf?rlkey=oiabxrg2wixp4414vv9n1azjh&dl=0' }, { label: 'Podcast', url: 'https://www.dropbox.com/scl/fi/rc2eodbpggwf0a1zscssh/Economic-Policy-Challenges-in-the-Age-of-AI.wav?rlkey=2p11fy6g379k7m3wtuo8vkllb&dl=0' } ] },
          { label: 'Grandmasters and Growth', sub: 'Rogoff, Project Syndicate, January 2010', url: 'https://www.project-syndicate.org/commentary/grandmasters-and-global-growth' }
        ],
        data: [
          { label: 'Coming soon', sub: 'Data to be added.' }
        ]
      ...
      'econ-policy-governance': {
        ...
        papers: [
          ...
          { label: 'Monetary Policy and the Short-Rate Disconnect in Emerging Economies', sub: 'De Leo, Gopinath & Kalemli-Özcan, 2025', url: 'https://sebnemkalemliozcan.com/assets/workingpapers/DGK_2025-08-20.pdf' },
        ...
        speeches: [
          { label: 'Steering through the Fog: The Art and Science of Monetary Policy in Emerging Markets', sub: 'Gopinath, IMF, May 2025', url: 'https://www.imf.org/en/News/Articles/2025/05/07/sp050725-science-of-monetary-policy-in-emerging-markets-gita-gopinath' },
          { label: 'A Strategic Pivot in Global Fiscal Policy', sub: 'Gopinath, Whitaker Lecture, Central Bank of Ireland, Sept 2024', url: 'https://www.imf.org/en/News/Articles/2024/09/17/sp091824-a-strategic-pivot-in-global-fiscal-policy' },
          { label: 'Introductory Remarks for the Conference "Fiscal Policy in an Era of High Debt"', sub: 'Gopinath, IMF, Nov 2023', url: 'https://www.imf.org/en/News/Articles/2023/11/17/sp-fdmd-gopinath-remarks-at-fiscal-forum-era-of-high-debt' },
          { label: 'Charting a Course Through Rough Seas: How Emerging Markets Can Navigate Tougher External Conditions', sub: 'Gopinath, SARB Biennial Conference, Sept 2023', url: 'https://www.imf.org/en/News/Articles/2023/09/01/sp090123-gita-gopinath-keynote-address-at-the-sarb-biennial-conference' }
        ],
        media: [
          { label: 'Responding to the Energy and Food Price Shock: Getting the Policy Details Right', sub: 'Gourinchas, IMF Blog, May 2026', url: 'https://www.imf.org/en/blogs/articles/2026/05/20/responding-to-the-energy-and-food-price-shock-getting-the-policy-details-right' },
          { label: 'Central Banking in an Age of Global Supply Shocks', sub: 'Kalemli-Özcan, Project Syndicate, May 29, 2026', url: 'https://www.project-syndicate.org/commentary/central-banks-job-much-harder-in-face-of-supply-shocks-by-sebnem-kalemli-ozcan-2026-05' },
          { label: 'The Age of Stagflation?', sub: 'Kalemli-Özcan, Project Syndicate Quarterly, December 15, 2025', url: 'https://www.project-syndicate.org/magazine/us-tariffs-and-monetary-policy-may-lead-to-stagflation-and-financial-instability-by-sebnem-kalemli-ozcan-2025-12' },
          { label: 'Why Do Populist Strongmen Love Low Interest Rates?', sub: 'Kalemli-Özcan, Project Syndicate, September 2025', url: 'https://www.project-syndicate.org/commentary/trump-erdogan-strongmen-want-low-interest-rates-for-electoral-purposes-by-sebnem-kalemli-ozcan-2025-09' }
        ],
        data: [
          { label: 'Coming soon', sub: 'Data to be added.' }
        ]
  ...
  // Explore-card carousels (Resources & Data page) — supports multiple
  // instances on the same page (one for "Explore our research, by topics",
  // one for "Discover our data"), each wired up independently.
  document.querySelectorAll('.topic-explore-card').forEach(function (topicCarousel) {
    var carouselTabs = topicCarousel.querySelectorAll('.topic-carousel-tab');
    var carouselSlides = topicCarousel.querySelectorAll('.topic-explore-pane');
    var carouselBgSlides = topicCarousel.querySelectorAll('.topic-explore-bgslide');
    var carouselOrder = Array.prototype.map.call(carouselTabs, function (tab) {
      return tab.getAttribute('data-slide');
    });

    function activateSlide(id) {
      carouselSlides.forEach(function (slide) {
        slide.classList.toggle('active', slide.getAttribute('data-slide') === id);
      });
      carouselBgSlides.forEach(function (bg) {
        bg.classList.toggle('active', bg.getAttribute('data-slide') === id);
      });
      carouselTabs.forEach(function (tab) {
        tab.classList.toggle('active', tab.getAttribute('data-slide') === id);
      });
    }

    function currentSlideIndex() {
      var activeTab = topicCarousel.querySelector('.topic-carousel-tab.active');
      var id = activeTab ? activeTab.getAttribute('data-slide') : carouselOrder[0];
      return carouselOrder.indexOf(id);
    }
    ...
    var carouselUp = topicCarousel.querySelector('[data-carousel-up]');
    var carouselDown = topicCarousel.querySelector('[data-carousel-down]');
    if (carouselUp) {
      carouselUp.addEventListener('click', function () {
        var i = currentSlideIndex();
        var nextIndex = (i - 1 + carouselOrder.length) % carouselOrder.length;
        activateSlide(carouselOrder[nextIndex]);
      });
    }
    if (carouselDown) {
      carouselDown.addEventListener('click', function () {
        var i = currentSlideIndex();
        var nextIndex = (i + 1) % carouselOrder.length;
        activateSlide(carouselOrder[nextIndex]);
      });
    }

    // Deep-link support: arriving via resources-data.html#<slide-id> (e.g.
    // from the homepage's Our Focus tiles) selects that slide and scrolls
    // to it. Harmless no-op on carousels whose ids don't match the hash.
    var initialTopic = window.location.hash.replace('#', '');
    if (initialTopic && carouselOrder.indexOf(initialTopic) !== -1) {
      activateSlide(initialTopic);
      setTimeout(function () {
        topicCarousel.scrollIntoView({ behavior: 'smooth', block: 'center' });
      }, 60);
    }
  });
