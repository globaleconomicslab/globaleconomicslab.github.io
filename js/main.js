  ...
  if (bioModal) {
    var bios = {
      ...
      itskhoki: {
        ...
        photo: 'images/oleg-itskhoki.jpg',
      ...
      kalemliozcan: {
        ...
        photo: 'images/sebnem-kalemli-ozcan.jpg',
        email: '',
    ...
    var topics = {
      ...
      fragmentation: {
        ...
        papers: [
          ...
          { label: 'Industrial Policies for Multi-Stage Production: The Battle for Battery-Powered Vehicles', sub: 'Head, Mayer, Melitz & Yang, NBER Working Paper 34884, February 2026', url: 'https://www.nber.org/system/files/working_papers/w34884/w34884.pdf' },
          ...
          { label: 'Putting the “Finance” into “Public Finance”: A Theory of Capital Gains Taxation', sub: 'Aguiar, Moll & Scheuer, Econometrica, forthcoming', url: 'https://markaguiar.github.io/files/PFPF.pdf' },
          { label: 'Opposing Firm-Level Responses to the China Shock: Output Competition versus Input Supply', sub: 'Aghion, Bergeaud, Lequien, Melitz & Zuber, American Economic Journal: Economic Policy, forthcoming', url: 'https://melitz.scholars.harvard.edu/sites/g/files/omnuum5906/files/melitz/files/aej_manuscript_ablmz_replicated.pdf' },
          ...
          { label: 'Stock Market Wealth and Entrepreneurship', sub: 'Chodorow-Reich, Nenov, Santos & Simsek, 2026', url: 'https://chodorowreich.scholars.harvard.edu/sites/g/files/omnuum7686/files/2026-04/StockMarketEntrepreneurship_2.pdf' },
          { label: 'How Good is International Risk Sharing?', sub: 'Aguiar, Itskhoki & Mukhin, December 2025', url: 'https://www.markaguiar.com/files/IRS_draft.pdf' },
          { label: 'The Macroeconomics of Tariff Shocks', sub: 'Straub, Auclert & Rognlie, December 2025', url: 'https://shade-econ.github.io/tariff_shocks.pdf?v=1' },
          ...
          { label: 'The Race Between Asset Supply and Asset Demand', sub: 'Straub, Auclert, Malmberg & Rognlie, Jackson Hole Symposium, November 2025', url: 'https://straub.scholars.harvard.edu/sites/g/files/omnuum7751/files/2025-11/Jackson%20Hole%20AMRS.pdf' },
          ...
          { label: 'The Saving Glut of the Rich', sub: 'Straub, Mian & Sufi, July 2025', url: 'https://straub.scholars.harvard.edu/sites/g/files/omnuum7751/files/2025-07/MSS_SGR_July242025.pdf' },
          ...
          { label: 'Tariff Wars and Net Foreign Assets', sub: 'Aguiar, Amador & Fitzgerald, April 2025', url: 'https://www.markaguiar.com/files/tariff_deficits.pdf' },
          ...
          { label: 'Micro Risks and (Robust) Pareto Improving Policies', sub: 'Aguiar, Amador & Arellano, American Economic Review, 114(11): 3669–3713, 2024', url: 'https://www.markaguiar.com/files/R_less_than_1_in_Aiyagari.pdf' },
          ...
          { label: 'Trade and Innovation', sub: 'Melitz & Redding, in The Economics of Creative Destruction, Harvard University Press, 2023', url: 'https://melitz.scholars.harvard.edu/sites/g/files/omnuum5906/files/melitz/files/tradeinnovation9sept2021.pdf' },
          { label: 'The Laffer Curve for Rules of Origin', sub: 'Head, Mayer & Melitz, October 2022', url: 'https://melitz.scholars.harvard.edu/sites/g/files/omnuum5906/files/melitz/files/hmm_roo_laffer_shared.pdf' },
          { label: 'Self-Fulfilling Debt Crises, Revisited', sub: 'Aguiar, Chatterjee, Cole & Stangebye, Journal of Political Economy, 130(5): 1147–1183, May 2022', url: 'https://www.markaguiar.com/files/self_fulfilling.pdf' },
          ...
          { label: 'International Trade and Innovation', sub: 'Akcigit & Melitz, in Handbook of International Economics, Vol. 5, pp. 377-404, Elsevier, 2022', url: 'https://melitz.scholars.harvard.edu/sites/g/files/omnuum5906/files/melitz/files/akcigit_and_melitz_-_2022_-_international_trade_and_innovation.pdf' },
        ...
        speeches: [
          { label: 'The Costs and Consequences of Sovereign Borrowing', sub: 'Aguiar, IMF Mundell-Fleming Lecture; IMF Economic Review, 2024', links: [ { label: 'Watch the video', url: 'https://www.imf.org/en/videos/view?vid=6340896615112' }, { label: 'Read the slides', url: 'https://markaguiar.github.io/files/MFpresentation.pdf' }, { label: 'Read the remarks', url: 'https://markaguiar.github.io/files/MFwriteup.pdf' }, { label: 'Read the piece', url: 'https://www.imf.org/en/Publications/fandd/issues/2024/06/The-Poisoned-Chalice-of-Debt-Mark-Aguiar?utm_medium=email&utm_source=govdelivery' }, { label: 'Listen to the podcast', url: 'https://www.imf.org/en/News/Podcasts/All-Podcasts/2024/08/08/mark-aguiar-on-debt' } ] },
      ...
      'emerging-tech': {
        ...
        media: [
          { label: 'Why Labor’s Share of Wealth Is Shrinking', sub: 'Neiman, NY Times, September 2026', url: 'https://www.nytimes.com/2026/09/07/opinion/labor-capitol-workers-income.html', linkLabel: 'Read the article' },
      ...
      'econ-policy-governance': {
        ...
        papers: [
          ...
          { label: 'Tax Policy and Investment in a Global Economy', sub: 'Chodorow-Reich, Smith, Zidar & Zwick, American Economic Review, forthcoming', url: 'https://chodorowreich.scholars.harvard.edu/sites/g/files/omnuum7686/files/2026-07/tcja_0.pdf' },
          ...
          { label: 'Housing Policy, Inflation, and Monetary Policy: An Unorthodox View', sub: 'Chodorow-Reich & Mehrotra, Brookings, February 2026', url: 'https://www.brookings.edu/wp-content/uploads/2026/02/20260206_ES_SupplySideInflationPapers_ChodorowReichMehrotra.pdf' },
          { label: 'Disaggregated Economic Accounts', sub: 'Straub, Andersen, Huber, Johannesen & Vestergaard, Quarterly Journal of Economics (forthcoming), December 2025', url: 'https://www.disaggregatedaccounts.com/assets/paper/DEA.pdf' },
          ...
          { label: 'Exchange Rates and Monetary Policy with Heterogeneous Agents: Sizing up the Real Income Channel', sub: 'Straub, Auclert, Rognlie & Souchier, August 2024', url: 'https://straub.scholars.harvard.edu/sites/g/files/omnuum7751/files/2025-07/ha_oe.pdf' },
          { label: 'Lessons from the Biggest Business Tax Cut in US History', sub: 'Chodorow-Reich, Zidar & Zwick, Journal of Economic Perspectives, 38(3), Summer 2024, pp. 61-88', url: 'https://chodorowreich.scholars.harvard.edu/sites/g/files/omnuum7686/files/chodorow-reich-et-al-2024-lessons-from-the-biggest-business-tax-cut-in-us-history.pdf' },
        ...
        media: [
          ...
          { label: 'Why Jerome Powell Had to Say No', sub: 'Chodorow-Reich, Project Syndicate, January 15, 2026', url: 'https://www2.project-syndicate.org/commentary/how-powell-and-congress-should-respond-to-doj-investigation-into-the-fed-by-gabriel-chodorow-reich-2026-01', linkLabel: 'Read the article' },
          ...
          { label: 'How to Avoid Another Recession', sub: 'Chodorow-Reich, NY Times, August 8, 2024', url: 'https://www.nytimes.com/2024/08/08/opinion/fed-rate-cuts-economy-recession.html', linkLabel: 'Read the article' }
        ],
        data: [
          { label: 'Coming soon', sub: 'Data to be added.' }
        ]
