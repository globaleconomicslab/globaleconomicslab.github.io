...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (projectGrid) {
    ...
    function startProjectAuto() { projectTimer = setInterval(swapProjectSet, 10000); }
    function stopProjectAuto() { if (projectTimer) { clearInterval(projectTimer); projectTimer = null; } }
