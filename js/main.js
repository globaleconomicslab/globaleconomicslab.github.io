...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Homepage featured-projects hero: ONE project (image + title + subtitle)
  // flows across the full width at a time, then flows out for the next as
  // the rotation advances. A single row of 6 dots below the image (one dot
  // per project) lets visitors jump straight to any of them. Auto-advances
  // every 20s (first advance sooner, at 8s, so it doesn't feel static on
  // load) and pauses on hover. Each project has its own background image;
  // the image cross-fades at the same moment the title/subtitle text swaps,
  // and the whole thing reads as one project flowing off and the next
  // flowing in — rather than a plain crossfade in place.
  ...
  if (projectGrid && projectDotEls.length) {
    var projects = [
      ...
      { title: 'The Future of Tax Policy: Public Finance in the Age of AI', subtitle: '', href: 'public-finance-age-of-ai.html', img: 'images/topics/ai.webp', alt: 'Abstract illustration of an AI circuit brain' },
      ...
      { title: 'Economic Policy Challenges for the Age of AI', subtitle: '', href: 'economic-policy-age-of-ai.html', img: 'images/topics/ai.webp', alt: 'Abstract illustration of an AI circuit brain' },
      { title: 'What Happens to Monetary Policy Without Commitment', subtitle: '', href: 'monetary-policy-without-commitment.html', img: 'images/topics/global-governance.jpg', alt: 'International flags flying together' }
    ];
